...
# ---------------- CONFIG (fill these) ----------------
GUILD_ID = 1469203259842494497  # your guild/server ID

# channels
TRANSACTIONS_ID = 1469208105559658702
MATCH_TIMES_CHANNEL_ID = 1469207269236412619
ASSIGNMENTS_CHANNEL_ID = 1470450104791077018
SCRIM_CATEGORY_ID = 0  # put your Scheduling category ID here, or 0 to create/use none
MATCH_SCORES_CHANNEL_ID = 1469207437637849205  # put your match-score channel ID here

# staff/team roles
CAPTAIN_ROLE_ID = 1470386102887256252
CO_CAPTAIN_ROLE_ID = 1470386187876438180
EXECUTIVE_ROLE_ID = 1513996853384056902
TEAM_PLAYER_ROLE_ID = 1470386516873187401
APPLY_BOT_ID = 1511910221159727214  # (replace with your actual apply bot user ID)

# assignment roles
HEAD_REF_ROLE_ID = 1513997892485124097
REF_ROLE_ID = 1470388292900880487
HEAD_CASTER_ROLE_ID = 1473258976933056656
CASTER_ROLE_ID = 1470388240602366126

FAQ_CHANNEL_ID = 1487302637693964318  # replace with the channel ID where FAQ should be posted
STREAM_WATCHER_ROLE_ID = 1511911568680550400  # 🎥 Stream Watcher
UNBORN_CAPTAIN_ROLE_ID = 1511911616373981254  # 🚀 Unborn Captain
EVENT_PING_ROLE_ID = 1511911646157865020      # 🎉 Event Ping
...
async def info(interaction: discord.Interaction):
    embed = discord.Embed(
        title="CTG Transactions Bot – Command Guide",
...
async def admin_info(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        title="CTG Transactions Bot – Admin Command Guide",
...
@bot.tree.command(
    guild=GUILD_OBJ,
    name="faq",
    description="Post the CTG FAQ and auto-role buttons (admins only)."
)
async def faq(interaction: discord.Interaction):
    ...
    text = (
        "# Comptive Tagging Gorillas Frequently Asked Questions\n\n"
        ...
        "> - We will use <#1487302556974841997> to update you on our team situation! We pick the best teams we can from out forms, so make sure you are active and competitive!\n"
        ...
        "## • Application Forms\n\n"
        "> - CTG has a various list of positions and applications to better help the league!,\n"
...
async def code(interaction: discord.Interaction, team1: discord.Role, team2: discord.Role):
    ...
    await interaction.response.defer(ephemeral=True)
    code_value = f"CTG{random.randint(1000, 9999)}"
